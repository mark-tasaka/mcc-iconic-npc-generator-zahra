...
<html>
<head>
<title>Iconic NPC Zahra Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_zahra.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_zahra_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Zahra Character Constructor
	*/
	function Character() {
    ...
    let healer = getZahra();
     ...
     /*getZahra() return the statistics for the healer per level*/  
    function getZahra() {
	let healer = [
	...
	return healer[1]; 
       ...
       let imgData = "images/zahra_character_sheet.png";
