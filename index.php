...
<html>
<head>
<title>Launch Page: Zahra Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
		<form action="" id ="zahraForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Zahra, Level 1</option>
				<option value="02">Zahra, Level 2</option>
				<option value="03">Zahra, Level 3</option>
				<option value="04">Zahra, Level 4</option>
				<option value="05">Zahra, Level 5</option>
				<option value="06">Zahra, Level 6</option>
				<option value="07">Zahra, Level 7</option>
				<option value="08">Zahra, Level 8</option>
				<option value="09">Zahra, Level 9</option>
				<option value="10">Zahra, Level 10</option>
			  </select>
        ...
        {
            $("#zahraForm").attr('action', "zahra/zahra"+ $("#level").val() +  ".php");
        });
